...
\setcounter{page}{1}
\chapter[Innledning]{\includegraphics[scale=0.5]{bilder/logo.png}}
...
\input{kapittel/resultater}

\chapter{Analyse}
\input{kapittel/analyse}
...
\appendix
\appendixpage
\includepdf[pages=1,scale=.8,pagecommand=\chapter{Spørreundersøkelse Involve},width=\textwidth]{appendiks/sporreundersokelse.pdf}
\includepdf[pages=2-,scale=.8,pagecommand={},width=\textwidth]{appendiks/sporreundersokelse.pdf}
\end{document}
